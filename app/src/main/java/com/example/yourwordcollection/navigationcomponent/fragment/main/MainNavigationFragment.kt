...
import com.example.yourwordcollection.navigationcomponent.fragment.main.logic.MainNavigationLogic
import com.example.yourwordcollection.navigationcomponent.fragment.wordlist.model.Word
import com.example.yourwordcollection.viewmodel.main.MainNavigationViewModel
...
class MainNavigationFragment : Fragment(), AlphabetAdapterListener {
    ...
    private val mainLogic = MainNavigationLogic()
